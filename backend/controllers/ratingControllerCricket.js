...
export const analyzeImageCricket = async (req, res) => {
  try {
    if (!req.file) {
    ...
    const response = await fetch('https://serverless.roboflow.com/infer/workflows/athletica/detect-and-classify-2', {
      method: 'POST',
